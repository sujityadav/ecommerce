...
export default function Footer(){
  ...
  <div className="xl:max-w-screen-xl 3xl:max-w-screen-2xl px-4 pt-16 pb-6 mx-auto  lg:pt-24">
        ...
        <ul className="flex justify-center gap-6 mt-8 md:gap-8 sm:justify-start">
          <li>
            <a
              ...
              target="_blank"
              className="text-[#2698df] transition hover:text-blue-500/75"
            >
    ...
    <div className="pt-6 mt-12 border-t border-gray-800">
      <div className="text-center sm:flex sm:justify-between sm:text-left">
        <p className="text-sm text-gray-400">
          ...
          <a
            className="inline-block text-[#2698df] underline transition hover:text-teal-500/75"
            href="/"
          >
            Terms & Conditions
          </a>
          ...
          <a
            className="inline-block ml-2 text-[#2698df] underline transition hover:text-teal-500/75"
            href="/"
          >
            Privacy Policy
          </a>
